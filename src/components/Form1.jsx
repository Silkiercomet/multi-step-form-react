...
const Form1 = ({setFullform, handleNumber, fullForm}) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='form1'>
      ...
      <input type="email" name='Email' inputMode='email' className='input__text' defaultValue={fullForm.email} {...register("email", { required: true })}/>
      <label htmlFor="Phone">Phone Number</label>
      <input type="text" name='Phone' inputMode='tel' className='input__text' defaultValue={fullForm.phone} {...register("phone", { required: true })}/>
